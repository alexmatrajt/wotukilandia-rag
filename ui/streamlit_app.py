...
st.set_page_config(
    page_title="Zephyria Legal RAG",
    page_icon="⚖️",
    layout="wide",
)

st.title("Zephyria Legal Research Assistant")
st.caption("Ask questions about the laws, regulations, cases, memos, and case files of Zephyria.")
...
with st.sidebar:
    st.header("About")
    st.write(
        "This is a local RAG app over your Zephyrian legal corpus. "
...
question = st.chat_input("Ask a legal question about Zephyria...")
...
if question:
    ...
    with st.chat_message("assistant"):
        with st.spinner("Researching the Zephyrian record..."):
